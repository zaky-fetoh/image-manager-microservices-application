...
class advertiser {
    ...
    async authenticate(RA_URI) {
         ...
         ***************/
        console.log(`authenticating service ${this.serviceName}`)
        try {
    ...
    async _register(RA_URI) {
         ...
         */
        try {
            console.log(`registering ${this.serviceName}`)
            const ra_res = await axios.post(
                `${RA_URI}/service`, {
    ...
    async _isRegisteredToRA(RA_URI) {
         ...
         ****************/
        try {
            console.log(`checking Service Existance ${RA_URI}`)
    ...
    async registerService_and_authenticate() {
         ...
         **********/
        try {
            console.log("discovering RA service")
